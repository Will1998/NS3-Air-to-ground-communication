      ...
      case WIFI_MOD_CLASS_HT:
        {
          ...
          m_htSig.SetChannelWidth (m_channelWidth);  //m_channelWidth
          m_htSig.SetHtLength (psdu->GetSize ());
          m_htSig.SetAggregation (txVector.IsAggregation ());
          m_htSig.SetShortGuardInterval (txVector.GetGuardInterval () == 12800); // TODO?
          NS_LOG_FUNCTION ("..."<<this << psdu << txVector << ppduDuration << band);
          break;
        }
      ...
      case WIFI_MOD_CLASS_HT:
        {
          ...
          txVector.SetChannelWidth (10);  //m_htSig.GetChannelWidth ()
          txVector.SetNss (1 + (m_htSig.GetMcs () / 8));
          txVector.SetGuardInterval(m_htSig.GetShortGuardInterval () ?12800 : 25600 ); //  TODO ?   400 : 800  12800 : 25600
...
WifiPpdu::GetTxDuration (void) const
{
  ...
  NS_LOG_DEBUG ("....ppduDuration"<<ppduDuration);
  return ppduDuration;
}
