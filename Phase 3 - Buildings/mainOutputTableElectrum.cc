...
*/
 ...
 NS_LOG_COMPONENT_DEFINE ("Table - Electrum Scenario");
 ...
 */
   ...
   for (uint16_t j = 0; j < dronePos_XYZ.size(); j++)
   {
	   ...
	   */
       ...
       positionAlloc->Add (Vector (0.0, 0.0, 1.5)); // AP position
    ...
    std::ofstream output_file("./scratch/result_output_Electrum.txt");
